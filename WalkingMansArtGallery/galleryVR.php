    ...
    <body>        
        <a-scene>
                ...
                <a-box id="artRoom" 
                    ...
                    <a-box position="0 15 400" height="30" width="500" depth="150" material="src: url(imgs/wall-texture-05.jpg)" shadow="cast: true">
                        ...
                        <a-box position="0 150 0" height="300" width="400" depth="25" material="src: url(imgs/wall-texture-05.jpg)" shadow="cast: true">
                            ...
                            <a-box id="Art-4" position="80 0 -12.5" height="200" width="130" depth="5" color="#FFFFFF" shadow="cast: true">
                                ...
                                <a-image id="Art-4" src="imgs/Art/Art4.jpg" height="165" width="95" position="0 0 -4" rotation="0 0 0"></a-image>
                            </a-box>
                            <a-box id="Art-7" position="-80 0 -12.5" height="200" width="130" depth="5" color="#FFFFFF" shadow="cast: true">
                                <a-box position="0 0 -1" height="180" width="110" depth="5" color="#000000" shadow="cast: true"></a-box>
                                <a-image id="Art-7" src="imgs/Art/Art7.jpg" height="165" width="95" position="0 0 -4" rotation="0 0 0"></a-image>
                            </a-box>
                            ...
                            <a-box id="Art-11" position="0 0 12.5" height="200" width="200" depth="5" color="#FFFFFF" shadow="cast: true">
                                ...
                                <a-image id="Art-11" src="imgs/Art/Art11.jpg" height="150" width="150" position="0 0 4" rotation="0 0 0"></a-image>
                            </a-box>
                        </a-box>
                    ...
                    <a-box position="0 15 -400" height="30" width="500" depth="150" material="src: url(imgs/wall-texture-05.jpg)" shadow="cast: true">
                        <a-box position="0 150 0" height="300" width="400" depth="25" material="src: url(imgs/wall-texture-05.jpg)" shadow="cast: true">
                            ...
                            <a-box id="Art-1" position="-120 0 12.5" height="200" width="108" depth="5" color="#FFFFFF" shadow="cast: true">
                                ...
                                <a-image id="Art-1" src="imgs/Art/Art1.jpg" height="175" width="85" position="0 0 4" rotation="0 0 0"></a-image>
                            </a-box>
                            <a-box id="Art-2" position="0 0 12.5" height="200" width="108" depth="5" color="#FFFFFF" shadow="cast: true">
                                <a-box position="0 0 1" height="185" width="95" depth="5" color="#000000" shadow="cast: true"></a-box>
                                <a-image id="Art-2" src="imgs/Art/Art2.jpg" height="175" width="85" position="0 0 4" rotation="0 0 0"></a-image>
                            </a-box>
                            <a-box id="Art-3" position="120 0 12.5" height="200" width="108" depth="5" color="#FFFFFF" shadow="cast: true">
                                <a-box position="0 0 1" height="185" width="95" depth="5" color="#000000" shadow="cast: true"></a-box>
                                <a-image id="Art-3" src="imgs/Art/Art3.jpg" height="175" width="85" position="0 0 4" rotation="0 0 0"></a-image>
                            </a-box>

                            <!-- Back Side -->
                            <a-box id="Art-15" position="0 0 -12.5" height="200" width="200" depth="5" color="#FFFFFF" shadow="cast: true">
                                <a-box position="0 0 -1" height="175" width="175" depth="5" color="#000000" shadow="cast: true"></a-box>
                                <a-image id="Art-15" src="imgs/Art/Art15.jpg" height="150" width="150" position="0 0 -4" rotation="0 0 0"></a-image>
                            </a-box>
                    ...
                    <a-box id="Art-10" position="487 300 -400" width="5" height="250" depth="223" rotation="0 0 0" color="#000000">
                        <a-box position="-4 0 0" width="5" height="213" depth="191" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-10" src="imgs/Art/Art10.jpg" height="183" width="158" position="-5 0 0" rotation="0 90 0"></a-image>
                        </a-box>
                   </a-box>
                   ...
                   <a-box id="Art-6" position="487 300 0" width="5" height="300" depth="195" rotation="0 0 0" color="#000000">
                        <a-box position="-4 0 0" width="5" height="276" depth="169" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-6" src="imgs/Art/Art6.jpg" height="254" width="147" position="-5 0 0" rotation="0 90 0"></a-image>
                        </a-box>
                    </a-box>
               
                   <a-box id="Art-13" position="487 300 400" width="5" height="250" depth="223" rotation="0 0 0" color="#000000">
                        <a-box position="-4 0 0" width="5" height="213" depth="191" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-13" src="imgs/Art/Art13.jpg" height="183" width="158" position="-5 0 0" rotation="0 90 0"></a-image>
                        </a-box>
                   </a-box>
                ...
                <a-box id="Hall" 
                    ...
                    <a-camera position="0 200 0" rotation="0 0 0" near="0.1" far="20000" look-controls wasd-controls="acceleration: 500"></a-camera>
                ...
                <a-light
                    ...
                    <a-box position="-700 300 -746" width="527" height="350" depth="5" rotation="0 0 0" color="#000000">
                        <a-box position="0 0 3" width="478.6" height="303" depth="5" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-18" src="imgs/Art/Art18.jpg"  width="444" height="271" position="0 0 4" rotation="0 0 0"></a-image>
                        </a-box>
                   </a-box> 
                   ...
                   <!-- <a-gltf-model id="art1" src="url(assets/wallDecor/modernWallFrame.glb)" scale="150 150 150" position="0 300 -700" rotation="90 0 0"></a-gltf-model> -->
                    <a-box position="0 300 -746" width="527" height="350" depth="5" rotation="0 0 0" color="#000000">
                        <a-box position="0 0 3" width="478.6" height="303" depth="5" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-19" src="imgs/Art/Art19.jpg" width="444" height="271"  position="0 0 4" rotation="0 0 0"></a-image>
                        </a-box>
                    </a-box>            

                   <a-box position="700 300 -746" width="527" height="350" depth="5" rotation="0 0 0" color="#000000">
                        <a-box position="0 0 3" width="478.6" height="303" depth="5" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-20" src="imgs/Art/Art20.jpg" width="444" height="271" position="0 0 4" rotation="0 0 0"></a-image>
                        </a-box>
                   </a-box> 
                   ...
                   <!-- Left Side -->
                    <a-box position="-700 300 746" width="527" height="350" depth="5" rotation="0 0 0" color="#000000">
                    <a-box position="0 0 -3" width="478.6" height="303" depth="5" rotation="0 0 0" color="#FFFFFF">
                        <a-image id="Art-21" src="imgs/Art/Art21.jpg" width="444" height="271" position="0 0 -4" rotation="0 0 0"></a-image>
                    </a-box>
                    </a-box> 

                    <a-box position="0 300 746" width="527" height="350" depth="5" rotation="0 0 0" color="#000000">
                        <a-box position="0 0 -3" width="478.6" height="303" depth="5" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-22" src="imgs/Art/Art22.jpg" width="444" height="271" position="0 0 -4" rotation="0 0 0"></a-image>
                        </a-box>
                    </a-box>            

                    <a-box position="700 300 746" width="527" height="350" depth="5" rotation="0 0 0" color="#000000">
                        <a-box position="0 0 -3" width="478.6" height="303" depth="5" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="Art-23" src="imgs/Art/Art23.jpg" width="444" height="271" position="0 0 -4" rotation="0 0 0"></a-image>
                        </a-box>
                    </a-box> 
                </a-box>
                ...
                <a-box id="lmRoom" 
                   ...
                   <a-box position="487 300 300" width="5" height="300" depth="400" rotation="0 0 0" color="#000000">
                        <a-box position="-4 0 0" width="5" height="280" depth="380" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="LandMark-1" src="imgs/Landmark/lm1.jpg" height="250" width="360" position="-5 0 0" rotation="0 90 0"></a-image>
                        </a-box>
                   </a-box>

                   <a-box position="487 300 -300" width="5" height="300" depth="400" rotation="0 0 0" color="#000000">
                        <a-box position="-3 0 0" width="5" height="280" depth="380" rotation="0 0 0" color="#FFFFFF">
                            <a-image id="LandMark-2" src="imgs/Landmark/lm2.jpg" height="250" width="360" position="-5 0 0" rotation="0 90 0"></a-image>
                        </a-box>
                   </a-box>
        ...
        <script src="js/reviewFunc.js"></script>
    </body>
</html>